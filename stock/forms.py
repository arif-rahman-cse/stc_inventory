...
class StockCreateForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'lc_per_dollar_cost_tk': forms.NumberInput(attrs={'class': 'form-control', 'value': '', 'id': 'id_lc_per_dollar_cost_tk'}),
            'lc_unit_cost_usd': forms.NumberInput(attrs={'class': 'form-control', 'value': '', 'id': 'id_lc_unit_cost_usd'}),
            'lc_unit_cost_tk': forms.NumberInput(attrs={'class': 'form-control', 'readonly': 'readonly', 'value': '', 'id': 'id_lc_unit_cost_tk'}),
            'total_amount_tk': forms.NumberInput(attrs={'class': 'form-control', 'readonly': 'readonly', 'value': '', 'id': 'id_total_amount_tk'}),
